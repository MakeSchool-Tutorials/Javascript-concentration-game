...
This tutorial creates a simple game with vanilla JavaScript. It covers the following topics and would be a good 
introductory tutorial for anyone learnign javaScript. 
